            ...
            <Row align='middle'>
                ...
                <Col xs={24} sm={10} style={{padding: 30}} >
                    <Space direction="vertical" style={{width: "80%"}} >
                        ...
                        <Button size='large' href='/launch'style={{width:150, height: "auto", paddingTop: 10, fontSize: "1.2rem", fontWeight: "bolder", margin: "10px 0", backgroundColor: "rgb(255, 50, 30)", color: "white", borderRadius: "10px"}} >Launch Pad</Button>
                        <Button size='large' href='/starlink'style={{width:150, height: "auto", verticalAlign: "middle", fontSize: "1.2rem", fontWeight: "bolder", margin: "10px 0", backgroundColor: "rgb(50, 26, 255)", color: "white", borderRadius: "10px"}} >Star Link</Button>
                    </Space>
                </Col>
            </Row>
        </div>
